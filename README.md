...
-------------------------------
- Dificuldades :
Nossa dificuldade foi marcada principalmente pela criação do código que seria usado no arduino, além da falta de alguns materiais importantes para a montagem do robô.

- Melhorias : 
Alteramos o chassi onde seria o local dos sensores ampliando-o para um melhor encaixe, unificamos os fios do arduino com fita isolante para uma melhor visualização e emendamos o fio da bateria para facilitar a organização. 
-------------------------------
Equipe:

- Alexandre Miguel Amorim
- Ana Clara Barbosa dos Santos
- Geniel Wilson Gonçalves da Silva
- Luiz Felipe Santiago Pinto
- Matheus Pereira Menezes Venas
-------------------------------
Professores:
- Ícaro Vasconcelos Alvim
