...
// A função vai captar através do trigger, e mandar o pulso através do echo, para a leitura da área e detecção de objetos
...
// Com o uso de sensores ultrassônicos, a área será mapeada para o rastreio do robô adversário
...
// Essa função nos possibilita uma movimentação mais suave, sem a necessidade de ataque
...
// FUNÇÃO COM A FINALIDADE DE FUGIR, CASO O ROBÔ ESTEJA SENDO EMPURRADO PARA FORA DA ARENA.
/*
CASO ESTEJA SENDO EMPURRADO PELO LADO ESQUERDO, O SENSOR INFRAVERMELHO VAI LER A FAIXA BRANCA DA ARENA, 
E O ROBÔ IRÁ ANDAR PRA FRENTE E FUGIR PARA O LADO DO ATACANTE.*/
...
//====================================================//
// FUNÇÕES PARA DETECÇÃO: todas as detecções são feitas pelos sensores ultrassônicos, que se encontram na frente e nas laterais do robô
...
// Função para a leitura da faixa branca da arena, evitando que nosso robô ande para fora, ou seja derrubado do campo
...
//====================================================//
// Função principal, onde todo o funcionamento do código ocorre e onde serão executadas as funções
void loop(){
